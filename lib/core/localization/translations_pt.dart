...
final Map<String, String> translationsPT = {
  ...
  'capture_gps': 'Capturar GPS',
  'manual_coordinates_hint':
      'Se a captura GPS não for possível, introduza manualmente as coordenadas da torre.',
  'location_card_hint':
      'Toque para gravar, editar ou apagar a posição da torre.',
  'gps_capture_success': 'Coordenadas GPS gravadas com sucesso.',
  'gps_capture_error': 'Não foi possível capturar as coordenadas GPS.',
  'location_services_disabled':
      'Ative a localização do dispositivo para capturar o GPS.',
  'location_permission_denied': 'Permissão de localização negada.',
  'location_permission_denied_forever':
      'Permissão de localização negada permanentemente. Ative-a nas definições.',
  'invalid_gps_coordinates':
      'Introduza coordenadas válidas no formato latitude, longitude.',
  'map_preview_waiting':
      'O mapa aparece assim que existirem coordenadas válidas.',
  'map_preview_hint':
      'Use o botão GPS para captar a posição atual ou escreva as coordenadas manualmente.',
  'save_success': 'Localização gravada com sucesso.',
  'error_saving': 'Não foi possível gravar a localização.',
  'error_deleting': 'Não foi possível apagar a localização.',
  'delete_success': 'Localização apagada com sucesso.',
  ...
  'torque_tensioning': 'Torque e Tensionamento',
  'title': 'Título',
  'type': 'Tipo',
  'type_hint': 'ex.: Mecânico, Elétrico',
  ...
  'expiring': 'A expirar',
  'expired': 'Expirado',
  'search_equipment_hint': 'Pesquisar equipamento por nome, modelo ou série',
  'equipment_load_error': 'Erro ao carregar equipamentos',
  'no_equipment_found': 'Nenhum equipamento encontrado',
  'add_first_equipment': 'Adicionar primeiro equipamento',
  'delete_equipment': 'Eliminar equipamento',
  'delete_equipment_confirm': 'Tem a certeza que deseja eliminar o equipamento',
  'equipment_deleted_success': 'Equipamento eliminado com sucesso',
  'equipment_delete_failed': 'Falha ao eliminar equipamento',
  'equipment_has_no_certificate': 'Este equipamento não tem certificado',
  'add_extra_connection': 'Adicionar ligação extra',
  'generate_standard_connections': 'Gerar ligações padrão',
  'connections_generated_success': 'Ligações geradas com sucesso',
  'no_connections': 'Nenhuma ligação encontrada',
  'add_component_dialog_title': 'Adicionar Componente',
  'component_name_hint': 'ex.: Gerador principal',
  'vui_hint': 'ex.: VUI-001',
  'item_number_hint': 'ex.: ITEM-01',
  'serial_number_hint': 'ex.: SN123456',
  'installation_order_hint': 'ex.: 1, 2, 3...',
  'installation_order_help':
      'Define a sequência de instalação deste componente',
  'component_name_required': 'Nome do componente é obrigatório',
  'installation_order_required': 'Ordem de instalação é obrigatória',
  'component_added_success': 'Componente adicionado com sucesso',
  'please_select_file': 'Selecione um ficheiro',
  'document_added_success': 'Documento adicionado com sucesso',
  'document_date': 'Data do documento',
  'subcategory_optional': 'Subcategoria (opcional)',
  'tags_comma_separated': 'Tags (separadas por vírgula)',
  'tags_hint': 'ex.: segurança, qualidade, inspeção',
  'related_turbines_comma_separated':
      'Turbinas relacionadas (separadas por vírgula)',
  'related_turbines_hint': 'ex.: WTG-01, WTG-02',
  'select_file': 'Selecionar ficheiro',
  'preparing_components': 'A preparar componentes...',
  'migration_once_per_turbine':
      'Esta migração automática é executada apenas uma vez por turbina.',
  'syncing_from_installation': 'A sincronizar componentes da instalação',
  'adding_hardcoded_ids': 'A adicionar campos hardcodedId',
  'fixing_component_names': 'A corrigir nomes de componentes',
  'creating_missing_components': 'A criar componentes em falta',
  ...
  'person_added': 'Pessoa adicionada com sucesso',
  'person_updated': 'Pessoa atualizada com sucesso',
  'member_added_to_project': 'Membro adicionado ao projeto',
  'no_people_yet': 'Ainda sem pessoas',
  'delete_category': 'Eliminar categoria',
  'delete_category_msg': 'Tem a certeza que pretende eliminar esta categoria?',
  'category_has_companies':
      'Não é possível eliminar a categoria enquanto existirem empresas.',
  'confirm_logout_msg': 'Tem a certeza que deseja terminar sessão?',
  ...
  'create_turbines_in_asbuilt': 'Crie turbinas no As-Built para começar',
  'save_settings_success': 'Configurações guardadas com sucesso',
  'save_settings_error': 'Erro ao guardar configurações',
  'mobile_password_required': 'Por favor insira a password',
  'mobile_password_min_length': 'Password deve ter pelo menos 6 caracteres',
  'mobile_installation_version_info': 'Versão mobile para instalação em campo',
  'contact_admin': 'Contacte o administrador',
  'no_location_available': 'Sem localização',
  'error_loading_projects': 'Erro ao carregar projetos',
  'error_loading_components': 'Erro ao carregar componentes',
  'no_components_available': 'Nenhum componente disponível',
  'phase_not_implemented': 'Fase não implementada',
  ...
  'as_built_dashboard': 'Painel de Controle',
  ...
  'delete_project_confirm':
      'Tem a certeza que quer eliminar o projeto e todos os dados associados',
  'project_deleted_success': 'Projeto eliminado com sucesso',
  'delete_project_error': 'Erro ao eliminar o projeto',
  ...
  'coordinates_hint_turbine': 'ex: 41.123456, -8.654321',
  ...
  'ncrs': 'NCRs',
  'ncr_new': 'Nova NCR',
  'ncr_management': 'Gestão de Não Conformidades',
  'ncr_evidence': 'evidências',
  'ncr_add_evidence': 'Adicionar evidências',
  'ncr_no_evidence': 'Sem evidências anexadas',
  'ncr_created_success': 'NCR criada com sucesso',
  'ncr_updated_success': 'NCR atualizada com sucesso',
  'ncr_deleted_success': 'NCR eliminada com sucesso',
  'ncr_delete_confirm': 'Tem a certeza que pretende eliminar esta NCR?',
  ...
  'daily_journal': 'Relatório Diário',
  'document_control': 'Controlo do Documento',
  'document_no': 'Document No.',
  'reference': 'Ref.',
  'report_date': 'Data do Relatório',
  'week': 'Semana',
  'report_no': 'N.º Relatório',
  'initials': 'Iniciais',
  'daily_journal_site_team': 'Equipa em Obra',
  'installation_team_count': 'N.º Montagem de Turbinas',
  'crane_crew_count': 'N.º Equipa de Gruas',
  'team_count_helper':
      'Pré-preenchido com a equipa atual do projeto. Pode ajustar para refletir o dia.',
  ...
  'wind_photo_helper':
      'Adiciona uma foto de confirmação para cada medição horária do vento.',
  'wind_photo_slot': 'Confirmação',
  'travelling_time': 'Tempo de Viagem',
  'manhours': 'Manhours',
  'time_format_hint': 'Formato HH:MM',
  'created_by': 'Criado por',
  'approved_by': 'Aprovado por',
  'sub_category': 'Subcategoria',
  'site_work_progress': 'Progresso dos Trabalhos em Obra',
  'erection_daily_remarks': 'Observações Diárias / Erection',
  'add_row': 'Adicionar linha',
  'save_daily_journal': 'Guardar Relatório Diário',
  'daily_journal_saved': 'Relatório Diário guardado com sucesso.',
  'daily_journal_load_error': 'Não foi possível carregar o Relatório Diário.',
  'daily_journal_editing': 'Relatório Diário carregado para edição:',
  'daily_journal_deleted': 'Relatório Diário eliminado com sucesso.',
  'daily_journal_not_found':
      'Não foi encontrado nenhum Relatório Diário para este dia.',
  'delete_daily_journal_confirm':
      'Tem a certeza que pretende eliminar o Relatório Diário deste dia?',
  'daily_journal_no_rows': 'Adiciona pelo menos uma linha com dados.',
  'daily_journal_intro':
      'Formulário nativo baseado no template Excel, mantendo as categorias e subcategorias originais.',
...
// ══════════════════════════════════════════════════════════════
  ...
  'daily_journal_help': 'Relatório Diário',
  ...
  'cranes_logistics_desc': 'Registo de atividades de pads e gruas gerais',
  ...
  'select_phase_to_open': 'Selecione uma fase para abrir o respetivo quadro.',
  'reports_content':
  ...
  'view_as_list': 'Ver em lista',
  'group_by_category': 'Agrupar por categoria',
  'search_documents_hint': 'Pesquisar por título, tag, ficheiro...',
  'clear_search': 'Limpar pesquisa',
  'clear_filters': 'Limpar filtros',
  'document': 'documento',
  'documents': 'documentos',
  'no_documents_found': 'Nenhum documento encontrado',
  'no_documents_registered': 'Sem documentos registados',
  'add_first_document_hint': 'Adiciona o primeiro documento com o botão +',
  'add_document': 'Adicionar documento',

  'project_team': 'Equipa do Projeto',
  'add_member': 'Adicionar Membro',
  'add_first_member': 'Adicionar primeiro membro',
  'member_actions_tooltip': 'Ações do membro',
  'edit_role': 'Editar role',
  'remove': 'Remover',
  'remove_member_title': 'Remover Membro',
  'remove_member_confirm': 'Remover do projeto:',
  'member_added_success': 'adicionado à equipa!',
  'user': 'Utilizador',
  'select_user': 'Selecionar utilizador...',
  'project_role': 'Role no Projeto',
  'can_generate_reports': 'Pode gerar relatórios',
  'project_reports_access_desc': 'Acesso à geração de relatórios do projeto',
  'edit_permissions': 'Editar Permissões',
  'no_team_members': 'Sem membros na equipa',

  'category_actions_tooltip': 'Ações da categoria',
  'company_actions_tooltip': 'Ações da empresa',
  'expand_category': 'Expandir categoria',
  'collapse_category': 'Recolher categoria',
  'show_people': 'Mostrar pessoas',
  'hide_people': 'Ocultar pessoas',

  'project_manager_role_desc': 'CRUD completo + gerir equipa do projeto',
  'site_supervisor_role_desc': 'CRUD em instalação, equipamento e documentação',
  'visitor_role_desc': 'Só leitura + geração de relatórios',
  ...
  'icon_building': 'Acampamento Base',
  'icon_crane': 'Gruas',
  'icon_lightning': 'Eletricidade (Cliente)',
  'icon_truck': 'Transportes',
  'icon_check': 'Supervisor',
  'icon_worker': 'Construção',
  'icon_factory': 'Comissionamento',
  'icon_barrier': 'HSE/EHS',
  'icon_minnig': 'Construção Civil',
  'icon_bolt': 'Mecânica',
  'icon_wrench': 'Auxiliar',
  ...
  'color_green': 'Verde',
  'color_purple': 'Roxo',
  'color_steel': 'Cinza-azulado',
  'color_dark_orange': 'Laranja escuro',

  // Team Permissions Screen
  'access_permissions': 'Acessos & Permissões',
  'roles_info_title': 'O que pode cada role fazer?',
  'role_pm_desc': 'CRUD completo + gerir equipa e permissões',
  'role_ss_desc': 'CRUD em instalação, equipamento e documentação',
  'role_visitor_desc': 'Só leitura + geração de relatórios',
  'remove_from_project': 'Remover do Projeto',
  'remove_member': 'Remover Membro',
  'select_user_hint': 'Selecionar utilizador...',
  'no_users_available': 'Todos os utilizadores já estão no projeto',
  'can_generate_reports_desc': 'Acesso à geração de relatórios do projeto',
  'no_members_yet': 'Sem membros com acesso',
  'no_members_desc': 'Adiciona o primeiro membro ao projeto',

  // ── NOVOS TÓPICOS DE AJUDA (Sistema de Permissões) ──
  'users_permissions_help': 'Utilizadores e Permissões',
  'users_permissions_help_desc': 'GlobalRole, ProjectRole e como gerir acessos',
  'team_management_help': 'Gestão de Equipa',
  'team_management_help_desc':
      'Adicionar membros e definir permissões por projeto',
};
