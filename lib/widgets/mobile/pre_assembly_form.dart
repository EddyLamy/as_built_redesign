...
/// Formulário de Pré-Assemblagem (Mobile)
class PreAssemblyForm extends ConsumerStatefulWidget {
  final String turbinaId;
  final String componentId;

  const PreAssemblyForm({
    super.key,
  ...
  @override
  ConsumerState<PreAssemblyForm> createState() => _PreAssemblyFormState();
}

class _PreAssemblyFormState extends ConsumerState<PreAssemblyForm> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      if (doc.exists) {
        final data = doc.data();
        final phase = data?['preAssembly'] as Map<String, dynamic>?;
