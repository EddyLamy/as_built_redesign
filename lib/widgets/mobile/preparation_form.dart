...
/// Formulário de Preparação (Mobile)
class PreparationForm extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<PreparationForm> createState() => _PreparationFormState();
}

class _PreparationFormState extends ConsumerState<PreparationForm> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      if (doc.exists) {
        final data = doc.data();
        final phase = data?['preparation'] as Map<String, dynamic>?;
